# ==============================================================================
# ADCS ESC2 Lab - Client Provisioning Script
# ==============================================================================
# Joins client to domain using DNS auto-discovery
# Fixes: Excludes NAT adapter (10.0.2.x) from configuration to prevent WinRM disconnect
# ==============================================================================
...
Write-Host "ADCS ESC2 Lab - Client Provisioning" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
...
try {
    ...
    if (-not $adapter) {
        # Fallback if no specific HostOnly found
...
if ($computerSystem.PartOfDomain) {
    ...
    try {
        ...
        # Join domain WITHOUT -Server parameter (DNS auto-discovery)
